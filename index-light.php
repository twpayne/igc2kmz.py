...
//
$_CONFIG['main_title'] = "IGC to KMZ converter";
...
//
$_CONFIG['hidden_files'] = array(".gitkeep", ".ftpquota", "index.php", "index.php~", ".htaccess", ".htpasswd");
...
//
$_CONFIG['starting_dir'] = "./uploaded_files/";
